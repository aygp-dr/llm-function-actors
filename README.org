...
[[https://img.shields.io/badge/platform-GNU%2FLinux-lightgrey.svg]]
...
#+begin_src mermaid :file actor-sequence.png :exports results
sequenceDiagram
    participant App as Application Actor
    participant LLM as LLM Actor
    
    App->>LLM: Initial Request + Functions
    LLM->>LLM: Analyze & Decide
    alt Function Call Needed
        LLM->>App: Function Call Request
        App->>App: Execute Function
        App->>LLM: Function Result
        LLM->>App: Final Answer with Result
